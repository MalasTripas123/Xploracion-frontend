...
function setPlayers() {
    gameState.players = [
        { id: "p1", name: "Player 1", hand: [], coins: 10, state: 'alive' },
        { id: "p2", name: "Player 2", hand: [], coins: 10, state: 'alive' },
        { id: "p3", name: "Player 3", hand: [], coins: 10, state: 'alive' },
        { id: "p4", name: "Player 4", hand: [], coins: 10, state: 'alive' },
        { id: "p5", name: "Player 5", hand: [], coins: 10, state: 'alive' },
        { id: "p6", name: "Player 6", hand: [], coins: 10, state: 'alive' },
    ]
}